(function() {
    ...
    function renderTweets(tweets: TweetData[]): void {
        ...
        for (let i: number = 0; i < tweets.length; i++) {
            ...
            avatarImg.onerror = function(this: HTMLImageElement) { this.onerror = null; this.src = 'https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png'; };
